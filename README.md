...
Usage: -s sourceRepoDir -t targetRepoDir
    ...
    -f, --reportFormat=              Specify markdown or csv or xml
        --manifestFile=
...
```
% ruby repo-keyword-scanner-for-modified-files.rb -t ~/work/android/s -g system/ -k "Copyright.*MyCompany" -f markdown
```